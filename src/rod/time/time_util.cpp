...
bool util::is_leap_year( int year ) {
	if ( (year%4) == 0 ) {
		if ( (year%100) == 0 ) {
			if ( (year%400) == 0 ) {
				return true;
...
int  util::number_of_days_between( int year_start , int year_end ) {
...
int  util::number_of_days_between( int year , int mon_start , int mon_end  ) {
...
int util::number_of_days( int year , int month ) {
